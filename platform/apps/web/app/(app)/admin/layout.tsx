...
const navItems = [
  ...
  { href: "/app/admin/brands", label: "Brands", icon: Building2 },
  { href: "/app/admin/campaigns", label: "Campaigns", icon: Megaphone },
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <Link key={item.href} href={item.href}>
                <div
                  className={`flex items-center gap-3 px-4 py-3 font-display text-sm font-bold uppercase tracking-wide transition-all ${
                    isActive
                      ? "bg-[#ffd700] text-black border-[3px] border-[#e6c200]"
          ...
          <div className="neo-card p-4 mb-4">
            <div className="flex items-center gap-3 mb-3">
              <Avatar size="default" className="border-[2px] border-black">
                <AvatarFallback className="bg-[#ffd700] text-black text-sm">
                  {initials}
                </AvatarFallback>
              </Avatar>
            ...
            <Badge variant="accent" className="text-xs text-black">Admin</Badge>
          </div>
          <Button
            variant="outline"
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 border-b-[3px] border-black bg-white z-50 flex items-center justify-between px-4">
        <Link href="/app/admin">
          <Badge variant="accent" className="text-sm px-3 py-1 text-black">
            Innings Admin
          </Badge>
        </Link>
        <button
